...
<head>
	...
	<meta name="description" content="Sistem Informasi Penggajian Tenaga Honorer BPN Banyumas">
	<meta name="keywords" content="Sistem Informasi Penggajian Tenaga Honorer BPN Banyumas">
	<meta name="author" content="Jihad">
	<title><?= $title ?> BPN Banyumas</title>
	...
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
					...
					<h3 class="brand-text">BPN Banyumas</h3></a></li>
		...
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			...
			<li class=" nav-item"><a href="#"><i class="ft-layers"></i><span class="menu-title"
				...
				<ul class="menu-content">
					<li class="<?php if ($this->uri->segment(1) == 'tenagahonorer') echo 'active' ?>"><a
							class="menu-item"
							href="<?= base_url('tenagahonorer') ?>"><i
								class="ft-users"> </i> Data Tenaga Honorer</a>
					</li>
