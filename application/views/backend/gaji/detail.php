	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				<h1 style="text-align: center">Detail Gaji <h1>
			</div>
			<div class="card-body">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					<label for="gaji_lihat_nama">Nama Tenaga Honorer</label>
					<input type="text" class="form-control" name="nama" id="gaji_lihat_nama" placeholder="Nama Tenaga Honorer"
		...
		<div class="modal-content">
			...
			<div class="modal-body ">
				<div class="kotak d-print-block">
					<div class="row">
						<div class="col-12">
							<div class="tengah"><h3><b>BPN BANYUMAS</b></h3></div>
							<div class="tengah">Jalan Jenderal Soedirman Nomor 356, Purwokerto, Kabupaten Banyumas</div>
							<hr>
							<div class="tengah"><b><u>SLIP GAJI TENAGA HONORER</u></b></div>
							<br>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-6">
							...
							<table style="width: 100%">
								...
								<!-- <tr>
									<td><b>Total</b></td>
									<td><b>:</b></td>
									<td><b>Rp. <span id="slip-gaji"></span></b></td>
								</tr> -->
							</table>
						</div>
						<div class="col-6">
					...
					<div class="row">
						...
						<div class="col-6 text-center">
							<p>Purwokerto, <?= date_indo(date('Y-m-d')) ?></p>
							<p>Admin</p>
							<br>
							<br>
							<br>
...
<div class="modal fade text-left" id="bayar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Tenaga Honorer sudah menerima gaji ?</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
