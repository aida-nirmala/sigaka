<div class="row">
	<div class="col-md-12">
		<div class="card box-shadow-2">
			<?php
			if ($this->session->flashdata('alert') == 'tambah_tenagahonorer'):
				?>
			...
			<?php
			elseif ($this->session->flashdata('alert') == 'update_tenagahonorer'):
				?>
				<div class="alert alert-success alert-dismissible animated fadeInDown" id="feedback" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
			...
			<?php
			elseif ($this->session->flashdata('alert') == 'hapus_tenagahonorer'):
				?>
			...
			<div class="card-header">
				<h1 style="text-align: center">Data Tenaga Honorer</h1>
				...
				<button  type="button" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2"
					...
					<i class="ft-plus-circle"></i> Tambah data tenaga honorer
				</button>
				<?php endif; ?>
			...
			<div class="card-body">
				<table class="table table-bordered zero-configuration">
					...
					<?php
					$no = 1;
					foreach ($tenagahonorer as $key => $value):
						?>
						<tr>
							<td><?= $no ?></td>
							<td><?= $value['tenagahonorer_nama'] ?></td>
							<td><?= $value['jabatan_nama'] ?></td>
							<td><?= date_indo($value['tenagahonorer_tanggal_gabung']) ?></td>
							<td><?= $value['tenagahonorer_nomor_hp'] ?></td>
							<td>
								<button
									class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 tenagahonorer-lihat"
									data-toggle="modal" data-target="#lihat" value="<?= $value['tenagahonorer_id'] ?>"
									title="Lihat selengkapnya"><i class="ft-eye"></i></button>
								<?php if ($this->session->userdata('session_hak_akses') == 'admin'):?>
								<button
									class="btn btn-success btn-sm  btn-bg-gradient-x-blue-green box-shadow-2 tenagahonorer-edit"
									data-toggle="modal" data-target="#ubah" value="<?= $value['tenagahonorer_id'] ?>"
									title="Update data tenagahonorer"><i class="ft-edit"></i></button>
								<button
									class="btn btn-danger btn-sm  btn-bg-gradient-x-red-pink box-shadow-2 tenagahonorer-hapus"
									data-toggle="modal" data-target="#hapus" value="<?= $value['tenagahonorer_id'] ?>"
									title="Hapus data tenagahonorer"><i class="ft-trash"></i></button>
								<?php endif;?>
							</td>
						</tr>
						<?php
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Tambah Data Tenaga Honorer</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<?= form_open('tenagahonorer/tambah') ?>
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					<label for="nama">Nama</label>
					<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Tenaga Honorer"
...
<div class="modal fade text-left" id="lihat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Lihat Data Tenaga Honorer</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="text" class="form-control" name="nama" id="lihat_nama" placeholder="Nama Tenaga Honorer"
				...
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_jabatan_tenagahonorer">Jabatan</label>
					<input type="text" class="form-control" name="jabatan" id="lihat_jabatan_tenagahonorer"
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="number" class="form-control" id="lihat_nohp" name="nomor_hp" 
							placeholder="Nomor HP"
						   autocomplete="off" readonly>
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_norek">Nomor Rekening</label>
					<input type="number" class="form-control" id="lihat_norek" name="nomor_rekening" 
...
<div class="modal fade text-left" id="ubah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Update Data Tenaga Honorer</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<?= form_open('tenagahonorer/update') ?>
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					<label for="edit_nama">Nama</label>
					<input type="hidden" id="tenagahonorer_id" name="id">
					<input type="text" class="form-control" name="nama" id="edit_nama" placeholder="Nama Tenaga Honorer"
						   autocomplete="off" required>
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
...
<div class="modal fade text-left" id="hapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Hapus Data Tenaga Honorer ?</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
