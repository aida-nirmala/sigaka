		...
		<div class="card box-shadow-2">
			...
			elseif ($this->session->flashdata('alert') == 'absen_sudah_ada'):
				...
				<div class="alert alert-danger alert-dismissible animated fadeInDown" id="feedback" role="alert">
					...
					Tenaga Honorer sudah absen hari ini
				</div>
			<?php
			endif;
			?>
			<div class="card-header">
				<h1 style="text-align: center">Absen Tenaga Honorer</h1>
								...
								<?php if ($this->session->userdata('session_hak_akses') == 'admin'): ?>
									...
									if ($value['absen_status'] == 'normal'):
										...
										<button
											...
											title="<?= $value['tenagahonorer_nama'] ?> lembur? "><i class="ft-moon"></i>
										</button>
									<?php
									elseif ($value['absen_status'] == 'lembur'):
										?>
										<button
											class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 absen-lembur"
											data-toggle="modal" data-target="#lembur" value="<?= $value['absen_id'] ?>"
											title="<?= $value['tenagahonorer_nama'] ?> lembur " disabled><i
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group floating-label-form-group">
					<label for="nama_tenagahonorer">Nama Tenaga Honorer</label>
					<input type="text" name="nama_autocomplete" id="nama_tenagahonorer" class="form-control"
						   placeholder="Nama Tenaga Honorer" required>
					<input type="hidden" id="id_tenagahonorer" name="nama">
				</div>
				<div class="form-group floating-label-form-group">
...
<!-- <div class="modal fade text-left" id="lembur" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> Tenaga Honorer Lembur ?</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
