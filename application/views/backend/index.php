								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											<h3 class="font-large-2 white"><?= $jumlah_tenagahonorer ?></h3>
											<h6 class="mt-1"><span class="text-muted white">Jumlah Semua Tenaga Honorer</h6>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Jumlah Tenaga Honorer Absen Hari Ini
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Jumlah Tenaga Honorer Yang Meminjam
											</h6>
										</div>
									</div>
								</div>
